class Caves extends Phaser.Scene {
    ...
    create() {
        ...
        gameState.bgColor = this.add.rectangle(0, 0, config.width, config.height, 0x292428).setOrigin(0, 0);
        gameState.bgColor.setScrollFactor(0);
        this.add.text(10, 50, 'CAVES', {fontSize: '50px', fill: '#000'});
        ...
        gameState.levelText = this.add.text(100, 10, `Level: ${this.level}`, {fontSize: '15px', fill: '#000'});
...
class Caves1 extends Caves {
    constructor() {
        super('Caves1')
        this.platformHeights = [2, 2, 2, null, null, null, 1, 1, 1, 1, 1, 1, null];
        this.platformHeights2 = [null, null, null, null, 6, 6, 5, 5, 4, 3, 3, null, 6];
        this.coinHeights = [null, 1, null, 4, null, null, null, null, 4, null, null, null, null];
        this.enemyHeights = [null, 2, 2, null, null, 6, null, 5, null, null, null, null, null];
        this.limit = 470;
        this.level = 'Caves-1';
    }
}

class Caves2 extends Caves {
    constructor() {
        super('Caves2')
        this.platformHeights = [3, 2, null, 2, null, 3, 3, null, 3, 2, 2, null, null];
        this.platformHeights2 = [null, null, 5, 5, 5, 6, null, 6, 6, null, 6, 5, 5];
        this.coinHeights = [null, null, null, 2, null, null, 3, null, null, 2, 2, null, null];
        this.enemyHeights = [null, null, null, 5, null, 6, null, null, 6, 6, null, 5, null];
        this.limit = 600;
        this.level = 'Caves-2';
    }
}

class Caves3 extends Caves {
    constructor() {
        super('Caves3')
        this.platformHeights = [5, null, 5, 4, 3, null, 3, null, 6, null, 6, null, 6];
        this.platformHeights2 = [null, null, 2, 1, null, null, null, 0.38, 0.38, 2, 2, 3, null];
        this.coinHeights = [null, null, null, 4, null, null, 3, null, null, 5, null, 5, null];
        this.enemyHeights = [null, null, 5, null, null, null, 3, null, null, null, 6, null, null];
        this.limit = 360;
        this.level = 'Caves-3';
    }
}

class Caves4 extends Caves {
    constructor() {
        super('Caves4')
        this.platformHeights = [4, 3, 2, null, 2, null, 6, 5, 4, null, 4, 3, 2];
        this.platformHeights2 = [5, 4, 3, null, null, null, 1, 1, 1, 1, 1, null, null];
        this.coinHeights = [null, null, 2, null, null, null, 6, null, null, 3, null, null, null];
        this.enemyHeights = [null, 3, null, null, 2, null, null, 5, null, null, null, 3, null];
        this.limit = 470;
        this.level = 'Caves-4';
    }
}