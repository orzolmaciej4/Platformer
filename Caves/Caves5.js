class Caves5 extends Phaser.Scene {
    constructor() {
        super('Caves5');
        this.heights = [2, 3, null, 5, 4, 3, null, 3, 2, null, 4, 3, 2];
        this.heights2 = [null, null, null, null, null, null, 6, null, 6, null, 6, 6, 5];
        this.coinHeights = [null, 3, null, null, 4, null, null, null, 2, null, 6, null, null];
        this.enemyHeights = [null, 3, null, null, null, null, null, null, null, null, null, 6, null];
        this.enemyHeights2 = [null, null, null, null, null, null, 6, null, null, null, null, 3, null];
        this.limit = 480;
        this.level = 'Caves-5';
    }
    ...
    createEnemy2(xIndex, yIndex) {
        if (typeof yIndex === 'number' && typeof xIndex === 'number') {
            gameState.enemies2.create((154 * xIndex) + 5,  (yIndex * 66) - 40, 'enemy2').setScale(1.5);
        } 
    }
